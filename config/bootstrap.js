...
module.exports.bootstrap = async function (cb) {
  ...
  let emailConfigEvents = ['Email Reminder Project Order', 'Email Reminder Pending Approval', 'Email Reminder Status Report', 'Email Reminder Closing Report', 'Small Order Started', 'Small Order Closed', 'Project Submission Notification', 'Project Recalled Email', 'Backup User Assignment Notification'];
